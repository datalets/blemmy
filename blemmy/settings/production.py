...
APP_NAME = env.get('APP_NAME', 'blemmy')
...
if 'LOG_DIR' in env:
    # Application log
    LOGGING['handlers']['blemmy_file'] = {
        'level':        'INFO',
        'class':        'cloghandler.ConcurrentRotatingFileHandler',
        'filename':     os.path.join(env['LOG_DIR'], 'blemmy.log'),
        'maxBytes':     5242880, # 5MB
        'backupCount':  5
    }
    LOGGING['loggers']['wagtail']['handlers'].append('blemmy_file')
